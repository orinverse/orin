...
"""Verify that starting orind with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start orind with -h for help text")
        ...
        self.log.info("Start orind with -version for version information")
        ...
        self.log.info("Start orindd with -fakearg to make sure it does not start")
