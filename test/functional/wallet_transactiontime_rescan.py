...
class TransactionTimeRescanTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]    # node used to mine ORIN and create transactions
        ...
        # generate some ORIN to create transactions and check blockcount
        ...
        # send 10 ORIN to user's first watch-only address
        self.log.info('Send 10 ORIN to user')
        ...
        # send 5 ORIN to our second watch-only address
        self.log.info('Send 5 ORIN to user')
        ...
        # send 1 ORIN to our third watch-only address
        self.log.info('Send 1 ORIN to user')
