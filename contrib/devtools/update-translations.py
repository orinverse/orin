...
# Regexp to check for Orin addresses
...
def contains_orin_addr(text, errors):
    if text is not None and ADDRESS_REGEXP_DASH.search(text) is not None:
        errors.append('Translation "%s" contains a Orin address. This will be removed.' % (text))
        return True
    return False
        ...
        for context in root.findall('context'):
            for message in context.findall('message'):
                ...
                for translation in translations:
                    ...
                    valid = valid and not contains_orin_addr(translation, errors)
