...
DASHD=${DASHD:-$BINDIR/orind}
SHARE_EXAMPLES_DIR=${SHARE_EXAMPLES_DIR:-$TOPDIR/contrib/debian/examples/}
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/orin.conf}
...
then
  ...
  echo -e "To safely generate a orin.conf file, please commit your changes to $DASHD, rebuild, then run this script again.\n"
fi

echo 'Generating example orin.conf file in contrib/debian/examples/'
...
## Generated by contrib/devtools/gen-orin-conf.sh.
##
...
# parse the output from orind --help
