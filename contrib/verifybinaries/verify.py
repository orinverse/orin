...
"""Script for verifying Orin Core release binaries

This script attempts to download the signature file SHA256SUMS.asc from
github.com and orincore-binaries.thepasta.org and compares them.
...
WORKINGDIR = "/tmp/orin_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1="https://github.com/orinpay/orin/releases/download/v"
HOST2="https://orincore-binaries.thepasta.org/file/orincore-binaries/"
VERSIONPREFIX=""
...
def main(args):
    ...
    if not success:
        print("github.com failed to provide signature file, "
              "but orincore-binaries.thepasta.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("github.com and orincore-binaries.thepasta.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the Orin Core binary release "
    ...
    for _, binary_filename in hashes_to_verify:
        ...
        if retval != 0:
            if retval == 1:
                ...
                print("gpg error. Do you have the Orin Core binary release signing key installed?")
            print("gpg output:")
            print(indent(output, '\t'))
