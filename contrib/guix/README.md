# Bootstrappable Orin Core Builds

This directory contains the files necessary to perform bootstrappable Orin
Core builds.
...
To build Orin Core reproducibly with all default options, invoke the
...
```
env DETACHED_SIGS_REPO=<path/to/orin-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/orinpay/guix.sigs).
