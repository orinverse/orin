...
const std::array<std::string, 33> V2_BITCOIN_IDS = {
    ...
    "", /* FEEFILTER is not implemented in Orin */
...
/** List of short messages allocated in Orin's reserved namespace, in order.
 *
 ...
 *
 * Bitcoin takes up short IDs up to 128 (lower half) while Orin can take
...
bool IsValidV2ShortID(uint8_t first_byte) {
    ...
    // and Orin's *used* slots. We do this by checking if the byte is within
