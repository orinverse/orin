...
;(function() {
  ...
  function runInContext(context) {
    // Exit early if unable to acquire loorin.
    var _ = context && context._ || require('loorin') || root._;
    if (!_) {
     ...
     *
     * Note: The Benchmark constructor exposes a handful of loorin methods to
     * make working with arrays, collections, and objects easier. The loorin
     * methods are:
     * [`each/forEach`](https://loorin.com/docs#forEach), [`forOwn`](https://loorin.com/docs#forOwn),
     * [`has`](https://loorin.com/docs#has), [`indexOf`](https://loorin.com/docs#indexOf),
     * [`map`](https://loorin.com/docs#map), and [`reduce`](https://loorin.com/docs#reduce)
     *
     * @constructor
     ...
     *
     * Note: Each Suite instance has a handful of wrapped loorin methods to
     * make working with Suites easier. The wrapped loorin methods are:
     * [`each/forEach`](https://loorin.com/docs#forEach), [`indexOf`](https://loorin.com/docs#indexOf),
     * [`map`](https://loorin.com/docs#map), and [`reduce`](https://loorin.com/docs#reduce)
     *
     * @constructor
     * @memberOf Benchmark
    ...
    // Add loorin methods to Benchmark.
    ...
    // Add loorin methods as Suite methods.
  ...
  if (typeof define == 'function' && typeof define.amd == 'object' && define.amd) {
    ...
    define(['loorin', 'platform'], function(_, platform) {
      return runInContext({
        '_': _,
        'platform': platform
      });
