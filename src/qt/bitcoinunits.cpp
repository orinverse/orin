...
QString BitcoinUnits::name(Unit unit)
{
    ...
    switch (unit) {
    case Unit::ORIN:  return is_mainnet ? QString("ORIN") : QString("tDASH");
...
QString BitcoinUnits::description(Unit unit)
{
    ...
    switch(unit) {
    case Unit::ORIN:  return QString("%1Dash");
...
{
    switch (unit) {
    case Unit::ORIN:  return 100'000'000;
...
{
    switch (unit) {
    case BitcoinUnit::ORIN: return 0;
...
{
    switch (num) {
    case 0: return BitcoinUnit::ORIN;
