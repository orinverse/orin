      ...
      walletModel(wallet_model)
{
    ...
    mapPointsPage = new MapPointsWidget(this);
    mapPointsPage->setWalletModel(walletModel);
...
void WalletView::gotoMapPointsPage()
{
    if (!mapPointsPage) return;
    setCurrentWidget(mapPointsPage);
}
