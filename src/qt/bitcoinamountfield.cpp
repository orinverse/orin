...
{
    Q_OBJECT
    BitcoinUnit currentUnit{BitcoinUnit::ORIN};
...
public:
    ...
    QSize minimumSizeHint() const override
    {
        ...
        int h = 0;
        int w = GUIUtil::TextWidth(fm, BitcoinUnits::format(BitcoinUnit::ORIN, BitcoinUnits::maxMoney(), false, BitcoinUnits::SeparatorStyle::ALWAYS));
        w += 2; // cursor blinking space
        w += GUIUtil::orinThemeActive() ? 24 : 0; // counteract padding from css
        return QSize(w, h);
    }
