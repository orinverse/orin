...
Assumeutxo is a feature that allows fast bootstrapping of a validating orind
...
considered active. This is the "traditional" mode of operation for orind.
...
**Failure consideration:** if orind unexpectedly halts after `m_stop_use` is set on
...
When orind initializes again, what began as the snapshot chainstate is now
