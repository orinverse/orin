...
This mechanism has been integrated into Bitcore-Node-Orin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/orinpay/insight-api-orin#web-socket-api](https://github.com/orinpay/insight-api-orin#web-socket-api)
* API: [https://github.com/orinpay/insight-api-orin#instantsend-transactions](https://github.com/orinpay/insight-api-orin#instantsend-transactions)
