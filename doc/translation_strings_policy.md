...
This document provides guidelines for internationalization of the Orin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `orin_en.ts` remains unchanged.
