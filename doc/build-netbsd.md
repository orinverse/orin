...
This guide describes how to build orind, command-line utilities, and GUI on NetBSD.

**This guide has not been tested for building Orin Core and may fail. Please report your results; contributions welcome.**
...
It is not necessary to build wallet functionality to run orind or the GUI.

###### Descriptor Wallet Support

`sqlite3` is required to enable support for [descriptor wallets](https://github.com/orinpay/orin/blob/master/doc/descriptors.md).
...
Orin Core includes a GUI built with the cross-platform Qt Framework. To compile the GUI, we need to install `qt5`.
...
There are many ways to configure Orin Core. Here is an example that
